	...
	<div class="static-content">
		<div class="page-content">
			<ol class="breadcrumb">                                
				...
				<li class="active"><a href="clientes_ausentes_salao_dias_filtro.php">Clientes que não repetiram o serviço a mais de X dias</a></li>
			</ol>
			
			<div class="page-heading">            
				<h1>Clientes que não repetiram o serviço a mais de X dias</h1>
				<div class="options">
				<?php 
...
<form action="clientes_nao_fazem_servico_dias.php" class="form-horizontal" name='frm' method="post">
			...
			<div class="panel panel-sky">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="form-group">
							<div class="col-md-3">
								<label class="control-label"><b>Serviço</b></label>
							</div>
