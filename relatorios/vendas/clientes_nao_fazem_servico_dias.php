...
<div id="wrapper">
    <div id="layout-static">
            ...
            <div class="static-content">
                <div class="page-content">
                    <ol class="breadcrumb">                                
						...
						<li class="active"><a href="conta.php">Clientes que não repetiram o serviço a mais de X dias</a></li>
                    </ol>
		...
		<div class="row">
			<div class="col-sm-8">
				<button class="btn-default btn" onclick="location.href='clientes_nao_fazem_servico_dias_filtro.php';">Voltar</button>
    ...
    {
     $sql = $sql."and         ci.cod_servico = ".$cod_servico."";   
    }
