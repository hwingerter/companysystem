	...
	<ul class="nav navbar-nav toolbar pull-right">
		...
		<li class="dropdown toolbar-icon-bg">
			...
			<ul class="dropdown-menu userinfo arrow">
				<li><a href="http://www.companysystem.net.br/minha_conta.php"><span class="pull-left">Minha Conta</span> <i class="pull-right fa fa-user"></i></a></li>
                <li><a href="http://www.companysystem.net.br/trocar_empresa.php"><span class="pull-left">Trocar Empresa</span> <i class="pull-right fa fa-building"></i></a></li>
				<li class="divider"></li>
				<li><a href="http://www.companysystem.net.br/logout.php"><span class="pull-left">Sair</span> <i class="pull-right fa fa-sign-out"></i></a></li>
			</ul>
		</li>
