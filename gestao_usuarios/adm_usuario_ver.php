...
if ($credencial_ver == '1') { //VERIFICA SE USU�RIO POSSUI ACESSO A ESSA �REA
	...
	$sql = "
	select		u.cod_usuario, tp.cod_empresa, tp.descricao as tipo_conta, tp.cod_tipo_conta, u.nome, u.status, u.email
	from 		usuarios u
		...
		<div class="panel-body">
			<form action="usuarios.php" class="form-horizontal row-border" name='frm' method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<label class="control-label"><?php echo $tipo_conta;?></label>						
					</div>
				</div>		
				<div class="form-group">
