...
if ($credencial_ver == '1') { //VERIFICA SE USU�RIO POSSUI ACESSO A ESSA �REA
	...
	if ($excluir != '') {
		$sql = "delete from Profissional where cod_profissional = ". $excluir;
		mysql_query($sql);
	...
	$sql = "Select COUNT(*) as total from profissional  ";
                    ...
                    <div class="static-content">
                        <div class="page-content">
                            ...
                            <div class="page-heading">            
							  ...
							  ?>
								<a class="btn btn-midnightblue btn-label" href="profissional_info.php"><i class="fa fa-plus-circle"></i> Novo</a>
							  <?php
							  }
							  ?>	
								</div>
...
<script language="JavaScript">
	function paginacao () {
  		document.forms[0].action = "produtos.php";
...
<form name="form1" method="post">
				...
				<div class="alert alert-dismissable alert-info">
					...
					<br><a class="btn btn-success" href="profissionais.php?excluir=<?php echo $pergunta;?>">Sim</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-danger" href="produtos.php">Não</a>
				</div>				
				<?php
				}
...
<form action="profissionais.php" class="form-horizontal row-border" name='frm' method="post">
			...
			<div class="panel panel-sky">
				...
				<div class="panel-body">
					<div class="form-group">
						<label class="col-sm-2 control-label"><b>Nome do Profissional</b></label>
						<div class="col-sm-6">
    ...
    <?php
		//CARREGA LISTA
	$sql = "
	select 		cod_profissional, nome, telefone, email, dia_aniversario, mes_aniversario, endereco 
	from 		profissional 
	...
	if ($registros > 0) {
		...
		?>
                        <tr>
                            <td align="left"><?php echo $rs['cod_profissional'];?></td>
							<td align="left"><?php echo $rs['nome']; ?></td>
							<td align="left"><?php echo $rs['telefone']; ?></td> 
							<td align="left"><?php echo $rs['email']; ?></td> 
							<td align="left"><?php echo $rs['dia_aniversario']." de ".RetornaMes($rs['mes_aniversario']); ?></td> 
							<td align="left"><?php echo $rs['endereco']; ?></td> 
                            <td align='center'>
					  	  <?php 
						  if ($credencial_editar == '1') {
						  ?>							
							<a class="btn btn-success btn-label" href="profissional_info.php?acao=alterar&id=<?php echo $rs['cod_profissional'];?>"><i class="fa fa-edit"></i> Editar</a>&nbsp;
					  	  <?php 
						  }
						  if ($credencial_excluir == '1') {
						  ?>
							<a class="btn btn-danger btn-label" href="profissionais.php?pergunta=<?php echo $rs['cod_profissional'];?>"><i class="fa fa-times-circle"></i> Excluir</a>
						  <?php
						  }
						  ?>	
							<a class="btn btn-info btn-label" href="profissional_ver.php?id=<?php echo $rs['cod_profissional'];?>"><i class="fa fa-eye"></i> Ver</a>

							<a class="btn btn-inverse btn-label" href="profissionais_habilidade.php?id=<?php echo $rs['cod_profissional'];?>&nome=<?php echo $rs['nome']; ?>"><i class="fa fa-tasks"></i> Habilidade</a>

							<a class="btn btn-primary btn-label" href="profissionais_horario.php?id=<?php echo $rs['cod_profissional'];?>&cod_empresa=<?php echo $cod_empresa; ?>&nome=<?php echo $rs['nome']; ?>"><i class="fa fa-clock-o"></i> Horário</a>
