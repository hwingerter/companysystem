	...
	<ul class="nav navbar-nav toolbar pull-right">
		...
		<li class="dropdown toolbar-icon-bg">
			...
			<ul class="dropdown-menu userinfo arrow">
                <li><a href="minha_conta.php"><span class="pull-left">Minha Conta</span> <i class="pull-right fa fa-user"></i></a></li>
                <li><a href="empresa/empresa_licenca_info.php?acao=ver_licenca"><span class="pull-left">Licença</span> <i class="pull-right fa fa-user"></i></a></li>
				<li class="divider"></li>
				<li><a href="logout.php"><span class="pull-left">Sair</span> <i class="pull-right fa fa-sign-out"></i></a></li>
			</ul>
		</li>
