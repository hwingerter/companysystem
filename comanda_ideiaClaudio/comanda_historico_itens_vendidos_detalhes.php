<?php include('../include/topo_interno.php');
	...
	$dtVenda			= $rs['dtVenda'];
	$TotalGeral			= ValorMysqlPhp($rs['TotalGeral']);
	$valor_pagamento	= ValorMysqlPhp($rs['valor_pagamento']);
	$troco				= ValorMysqlPhp(($rs['TotalGeral'] - $rs['valor_pagamento']));
	$cliente			= $rs['cliente'];
										...
										<div class="form-group">
											...
											<table class="table" border="1" bordercolor="#EEEEEE" style="margin: 0 auto; width: 100%;">
												...
												<tbody>
													...
													and 		ci.cod_comanda_item = ".$cod_comanda_item."
