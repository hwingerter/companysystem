...
if ($credencial_ver == '1') { //VERIFICA SE USUÁRIO POSSUI ACESSO A ESSA ÁREA
	...
	if($registros > 0)
	{
		if($rs = mysql_fetch_array($query))
		{
			...
			//echo $rs['dt_caixa']." - a".$dt1." <br> b".$dt2;
	...
	{
		//$caixa = "fechado";
		echo "<script language='javascript'>window.location='../caixa/caixa_gaveta_caixa.php';</script>";die;			
	}	
					...
					if ($registros > 0) {
                        ...
                        <tr>
                            ...
                            <td align='center'>
								...
								?>
									<a class="btn btn-success btn-label" href="nova_comanda.php?cod_comanda=<?php echo $rs['cod_comanda'];?>&cod_cliente=<?php echo $rs['cod_cliente'];?>"><i class="fa fa-edit"></i>Editar</a>
								...
								<a class="btn btn-info btn-label" href="comanda_forma_pagamento.php?cod_comanda=<?php echo $rs['cod_comanda'];?>&cod_cliente=<?php echo $rs['cod_cliente']; ?>"><i class="fa fa-money"></i>Receber</a>
