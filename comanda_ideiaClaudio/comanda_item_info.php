												...
												<form action="comanda_item_info.php" class="form-horizontal row-border" name='frm' method="post">
									              ...
									              <?php } ?>			
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
														  <input type="text" class="form-control" value="<?php echo $quantidade;?>" name="quantidade" maxlength="10">				
														</div>
													</div>
												...
												<div class="panel-footer">
													<div class="row">
														<div class="col-sm-8 col-sm-offset-2">
															...
															<button class="btn-default btn" onclick="javascript:window.location='comanda_lista.php?cod_comanda=<?php echo $cod_comanda;?>&cod_cliente=<?php echo $cod_cliente;?>';">Cancel</button>
														</div>
													</div>
												</div>
