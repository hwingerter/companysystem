			  ...
			  <input type="hidden" name="voltar" value="<?php echo $voltar; ?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<label class="checkbox-inline icheck">
							<input type="checkbox" name="area1" id="todos_sistema" value="1"
							  <?php 
							  for($i=1; $i<=$totalcred;$i++) {
				...
				<div class="panel-heading">
					...
					<span style="padding-left:5px;">
							<label class="checkbox-inline icheck">
								<input type="checkbox" name="area1" id="todos_sistema" value="1"> Selecionar Todos
							</label>
						</span>
				</div>				
				<div class="form-group">
			...
			<div class="panel-footer">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						...
						<button class="btn-default btn" onclick="javascript:window.location='<?php echo $voltar; ?>';">Cancel</button>
					</div>
				</div>
			</div>
		</div>
